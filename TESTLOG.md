...
|11|Failure|[Run Link](https://github.com/asyncapi-actions-test/cli/actions/runs/20662451815/job/59327790261)| Adding to same step caused failure probably due to using [`getExecOutput`](https://github.com/changesets/action/blob/main/src/run.ts#L89)|